// components/home/ResumenParcelas.tsx
...
export default function ResumenParcelas() {
  ...
  if (loading) {
    return (
      <View className="bg-white dark:bg-gray-800 rounded-2xl p-5 mb-4 shadow items-center py-8">
        ...
        {parcelas.map((p) => {
          ...
          return (
            <TouchableOpacity
              ...
              className="bg-white dark:bg-gray-800 rounded-2xl p-4 mr-3 shadow border border-gray-100 dark:border-gray-700"
              style={{ width: 160 }}
            >
              {/* Indicador de estado */}
              <View className="flex-row items-center justify-between mb-3">
                <View style={{ backgroundColor: interp.color + '20' }}
